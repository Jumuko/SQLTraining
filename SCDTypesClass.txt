...
--CREATE 2 TABLES: ONE IS EMADEPRODUCTLIST SOURCE, THE OTHER ONE EMADEUPDATEDLIST TARGET.
DROP TABLE IF EXISTS EMADEPRODUCTLIST;
CREATE TABLE EMADEPRODUCTLIST
(PRODUCTID INT NOT NULL, PRODUCTNAME VARCHAR(50) , PRICE MONEY)

INSERT INTO EMADEPRODUCTLIST
VALUES
(101,'TEA',10.00),
(102,'COFFEE',15.00),
(103,'BISCUITS',20.00)

DROP TABLE IF EXISTS EMADEPRODUCTUPDATEDLIST;
CREATE TABLE EMADEPRODUCTUPDATEDLIST
(PRODUCTID INT NOT NULL, PRODUCTNAME VARCHAR(50) , PRICE MONEY)

INSERT INTO EMADEPRODUCTUPDATEDLIST
VALUES
(101,'TEA',10.00),
(102,'COFFEE',35.00),
(104,'CHIPS',22.00)
...
SELECT *
FROM EMADEPRODUCTLIST

SELECT *
FROM EMADEPRODUCTUPDATEDLIST

-- PLACE ENDDATE, STARTDATE, AND IS_ACTIVE FIELD TO TARGET
ALTER TABLE EMADEPRODUCTUPDATEDLIST
ADD STARTDATE DATE, 
    ENDDATE DATE;

ALTER TABLE EMADEPRODUCTUPDATEDLIST
ADD IS_ACTIVE VARCHAR(50)

-- INSERT VALUES NEW COLUMNS TO TARGET 
UPDATE EMADEPRODUCTUPDATEDLIST
...
--PERFORM MERGE OPERATION FOR SCD TYPE 2
MERGE INTO EMADEPRODUCTUPDATEDLIST AS TARGET
USING EMADEPRODUCTLIST AS SOURCE
ON TARGET.PRODUCTID = SOURCE.PRODUCTID
...
--TOMORROWS TASK: INCREMENTAL LOAD, DELTA LOAD.